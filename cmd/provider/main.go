...
import (
	...
	"github.com/stakater/provider-confluent/apis"
	"github.com/stakater/provider-confluent/apis/v1alpha1"
	"github.com/stakater/provider-confluent/config"
	"github.com/stakater/provider-confluent/internal/clients"
	"github.com/stakater/provider-confluent/internal/controller"
	"github.com/stakater/provider-confluent/internal/features"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ratelimiter.LimitRESTConfig(cfg, *maxReconcileRate), ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-gcp-oslogin",
		Cache: cache.Options{
